...
enum Uploader {
    static func send(token: String, apiUrl: String, bucketId: String, uploadUrl: URL, fileName: String, file: Data, lastModified: Date, completion: @escaping (Result<(), Error>) -> ()) {
    ...
    private static func getUploadUrlThenUpload(failures: Int, token: String, apiUrl: String, bucketId: String, fileName: String, file: Data, lastModified: Date, completion: @escaping (Result<(), Error>) -> ()) {
